...
# Créer le nuage de points avec Seaborn
sns.scatterplot(data=DF, x='Prix MWh', y='g/MWH',color='blue')
sns.scatterplot(data=ImportanceEquiv, x='Prix MWh', y='g/MWH',color='red')
sns.scatterplot(data=ImportancePrix, x='Prix MWh', y='g/MWH',color='purple')
